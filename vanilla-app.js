//using DOM method to add event to get button
let getbtn = document.getElementById('1');
getbtn.addEventListener('click', fetchHandler);

//making handler for fetching data through pure xml
